...
CREATE TABLE IF NOT EXISTS lifecycle_input_qa (
    ...
    missing_market_regime_sessions_json VARCHAR NOT NULL DEFAULT '[]',
    expected_theme_score_keys_json VARCHAR NOT NULL DEFAULT '[]',
    missing_theme_score_keys_json VARCHAR NOT NULL DEFAULT '[]',
    ...
    missing_market_regime_coverage_warning BOOLEAN NOT NULL DEFAULT false,
    missing_theme_score_coverage_warning BOOLEAN NOT NULL DEFAULT false,
